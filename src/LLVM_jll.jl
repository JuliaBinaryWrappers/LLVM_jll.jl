...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import LLVM_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("86de99a1-58d6-5da7-8064-bd56ce2e322c"))
platforms = [Pkg.Artifacts.unpack_platform(e, "LLVM", artifacts_toml) for e in artifacts["LLVM"]]
...
if best_platform === nothing
    @debug("Unable to load LLVM; unsupported platform $(triplet(platform_key_abi()))")
else
