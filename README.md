...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/e5dfd9ac8dac552060050483c102992fb730c7fa/L/LLVM/LLVM@14/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* `Linux x86_64 {cxxstring_abi=cxx03, libc=glibc, llvm_version=14.asserts, sanitize=memory}` (`x86_64-linux-gnu-cxx03-sanitize+memory-llvm_version+14.asserts`)
